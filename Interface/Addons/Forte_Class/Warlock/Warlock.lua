...
if FW.CLASS == "WARLOCK" then
	...
	if ST then
		...
		:AddSpell(  348,  15,"Default",	F.TICKS+F.REFRESH):SetSpellModSetB("Voidheart Raiment",4,3) -- Immolate, refresh by Fel Flame
		...
		:AddSpell(80240,  15,"Bane",	F.SHARED+F.UNIQUE) -- Bane of Havoc
		:AddSpell(  980,  24,"Bane",	F.TICKS+F.SHARED):SetTickSpeed(2):SetSpellModGlph(56241,4) -- Bane of Agony
		:AddSpell(  603,  60,"Bane",	F.TICKS+F.SHARED):SetTickSpeed(15):SetHasted(0) -- Bane of Doom
