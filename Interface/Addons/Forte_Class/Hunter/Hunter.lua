...
if FW.CLASS == "HUNTER" then
	...
	if ST then
		...
		:AddSpell(51755,  60,"Crowd",	F.UNIQUE+F.NOTARGET) -- Camouflage
		...
		:AddSpell(82654,  30,"Default") -- Widow Venom
		...
		:AddSpell(35387,  30,"Pet") -- Armor Reduction (Sunder Armor) - Serpent
		:AddSpell(35290,  15,"Pet") -- Increaed Bleed Damage - Boar
		:AddSpell(50271,  15,"Pet") -- Increaed Bleed Damage - Hyena
		...
		-- hunter buffs
		:AddBuff(53434) -- Call of the Wild
		...
		:AddSpell( 1499,  60,"Crowd"):SetSpellModTlnt(19376,{6,12,18}) -- Freezing Trap
