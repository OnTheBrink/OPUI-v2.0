...
function FW:NewOptionsPanel()
	...
	obj.Draw = function(self)
						...
						if d[5] then
							...
							if d[11] then
								if not options_built then
									...
									s.spell_list = s.spell_list.."|r";
								end
								if FW.Settings.TimerSpellsTooltip then
									s.tip = s.tip..s.spell_list;
								end
							end
		...
		self.scrollframe.maxscroll = FW_Options[1].option:GetTop()-FW_Options[#FW_Options].option:GetBottom()-self.scrollframe:GetHeight();
